...
class myEnedisSensorCoordinatorTempo(CoordinatorEntity, RestoreEntity):
    """."""
    ...
    def unique_id(self):
        ...
        name = f"myEnedis.{self._myDataSensorEnedis.get_PDL_ID()}.Tempo"
        return name
    ...
    async def async_added_to_hass(self):
        ...
        try:
            if "typeCompteur" in state.attributes:
                ...
                _LOGGER.debug("Redemarrage avec element present ??")
        except:
            _LOGGER.debug("Redemarrage mais rien de present")
